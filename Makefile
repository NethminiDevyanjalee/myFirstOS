OBJECTS = loader.o kmain.o io.o gdt.o memory_segments.o interrupt_handlers.o interrupts.o pic.o idt.o keyboard.o paging_enable.o paging.o kheap.o common.o hardware_interrupt_enabler.o  user_mode.o serial.o framebuffer.o
    CC = gcc
